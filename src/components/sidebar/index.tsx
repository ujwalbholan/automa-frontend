...
const MenuOptions = () => {
  ...
  return (
    ...
    flex items-center flex-col  gap-10 py-6 px-2 no-scrollbar "
    >
      <div className="flex items-center justify-center flex-col gap-5">
          ...
          {menuOptions.map((menuItem) => (
            <ul key={menuItem.name}>
              <Tooltip delayDuration={0}>
                ...
                <TooltipContent
                  side="right"
                  className="dark:bg-white/25 backdrop-blur-xl"
                >
                  <p>{menuItem.name}</p>
                </TooltipContent>
              </Tooltip>
        ...
        <Separator />
        {/* <div className="flex items-center flex-col gap-5 dark:bg-[#353346]/30 py-4 px-2 rounded-full h-56 overflow-scroll border-[1px]">
